...
Nie musisz marzyć o tworzeniu gier, żeby znaleźć tu coś dla siebie. Unreal Engine jest wykorzystywany nie tylko w gamedevie, ale również przy produkcji filmów, wizualizacjach architektonicznych czy tworzeniu interaktywnych interfejsów, np. w samochodach.
...
Porozmawiamy też z gości zawodowo pracujących z Unreal Engine, którzy pokażą nam inne strony tej branży — m.in. tworzenie środowisk , materiałów i efektów specjalnych oraz wykorzystanie Unreal Engine w produkcji filmowej.

# Informacje organizacyjne

Kurs obejmuje 20 godzin zajęć.

Spotkania będą podzielone na:

[T] — zajęcia teoretyczne, podczas których będziemy rozmawiać o konkretnych zagadnieniach;
[P] — zajęcia praktyczne, podczas których będziemy wspólnie tworzyć własną grę w Unreal Engine.
...
LinkedIn:
https://www.linkedin.com/in/damian-kolenda/

Szczegółowy program kursu
1. Wstęp do tworzenia gier [T/P]
Jak powstają gry?
...
6. Unreal Engine — animacje, cz. 2 [P]
...
Metody szybkiego tworzenia historii:
graf świata,
historia zbudowana wokół przedmiotu,
siedem złotych pytań kryminalistycznych
8. Unreal Engine — porządkowanie i optymalizacja projektu [P]
Debugowanie
Analiza zależności
...
Event Dispatcher,
Subsystem
9. Wprowadzenie do level designu [T]
...
19. AI aktorów, cz. 2 / spotkanie z gościem [P]
...
20. C++ i AI jako pomoc w programowaniu [T/P]
